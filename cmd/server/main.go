...
func main() {
	...
	e.Use(middleware.SecureWithConfig(middleware.SecureConfig{
		...
		ContentSecurityPolicy: "default-src 'self'; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://cdn.tailwindcss.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.jsdelivr.net https://unpkg.com https://cdn.tailwindcss.com; img-src 'self' data: https:; font-src 'self' data:; frame-ancestors 'self';",
	...
	e.GET("/forgot-password", handlers.ForgotPasswordGET)
	e.POST("/forgot-password", handlers.ForgotPasswordPOST, rateLimiter)
	e.GET("/reset-password", handlers.ResetPasswordGET)
	e.POST("/reset-password", handlers.ResetPasswordPOST, rateLimiter)
