...
func Register() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<!doctype html><html lang=\"id\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><title>Daftar - JurnalUmi</title><script src=\"https://cdn.tailwindcss.com\"></script></head><body class=\"bg-gray-50 flex items-center justify-center min-h-screen p-4\"><div class=\"bg-white p-8 rounded-2xl shadow-xl max-w-md w-full border border-gray-100\"><div class=\"text-center mb-8\"><h1 class=\"text-3xl font-extrabold text-emerald-600 mb-2\">JurnalUmi</h1><p class=\"text-gray-500 text-sm\">Buat Akun Keluarga Baru (Gratis)</p></div><form action=\"/register\" method=\"POST\" class=\"space-y-4\"><input type=\"hidden\" name=\"csrf_token\" value=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func ResetPassword(token string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/views/auth.templ`, Line: 220, Col: 77}
		}
